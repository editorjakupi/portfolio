...
export default function Contact() {
  ...
  const items = [
    ...
    { label: t.contact.location, text: profile.address },
    ...
    { label: t.contact.languages, text: t.hero.languages },
    { label: t.contact.drivingLicence, text: profile.drivingLicence },
  ];
      ...
      <div className="container">
        ...
        <div className="contact-grid">
          {items.map((item) => {
            ...
            if (!item.href) {
              return (
                <div key={item.label} className="contact-card reveal">
                  {content}
                </div>
              );
            }
