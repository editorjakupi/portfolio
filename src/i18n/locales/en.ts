...
const en: Translations = {
  ...
  about: {
    ...
    p2:
      'Today I am completing my AI-focused software development education at NBI Handelsakademin (graduating June 2026) alongside computer engineering studies at Halmstad University. I have completed LIA internships at PodManager.AI (full-stack audio/AI platform) and Swiiftly (restaurant AI assistant with RAG, OCR, and governance).',
