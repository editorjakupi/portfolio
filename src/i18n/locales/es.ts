...
const es: Translations = {
  ...
  about: {
    ...
    skillGroups: [
      ...
      {
        title: 'IA y datos',
        items: ['Machine Learning', 'RAG', 'Integración LLM', 'TensorFlow/Keras', 'Streamlit'],
      },
      {
  ...
  contact: {
    ...
    subtitle:
      '¿Buscas un desarrollador para prácticas, un puesto junior o colaboración en un proyecto? Me encantaría saber de ti.',
    email: 'Correo',
    phone: 'Teléfono',
    linkedin: 'LinkedIn',
    github: 'GitHub',
